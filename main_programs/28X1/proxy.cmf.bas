...
#picaxe 28x1
symbol ADCReadleft = b1
symbol ADCReadCenter = b2
symbol ADCReadRight = b3
...
;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
	...
	if ADCReadleft>100 and ADCReadCenter<100 and ADCReadRight<100 then gosub RotateCW
	if ADCReadleft<100 and ADCReadCenter<100 and ADCReadRight>100 then gosub RotateCCW
	debug
	goto main
